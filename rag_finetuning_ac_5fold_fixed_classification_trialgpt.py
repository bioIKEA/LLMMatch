...
for fold, (train_index, val_index) in enumerate(kf.split(df_fine_tune)):
    ...
    training_args = TrainingArguments(
        output_dir=f"./checkpoints_classification_fold_{fold}_1",
        ...
        fp16=True,
        save_total_limit=2,
        logging_dir=f"./logs_classification_fold_{fold}_1",
        logging_steps=10,
    ...
    output_dir = f"./fine_tuned_peft_model_classification_{fold}_1"
    ...
    save_dir = f"./fine_tuned_complete_model_classification_{fold}_1"
